...
class contentEngine implements searchEngine {
	...
	public function searchForm() {
		...
		if ($this->columns == 2) { $form->addHTML('<div class="elx5_2colwrap"><div class="elx5_2colbox">'); }
		...
		if ($this->columns == 2) { $form->addHTML('</div><div class="elx5_2colbox">'); }
		...
		if ($this->columns == 2) { $form->addHTML('</div></div>'); }
	...
	public function showResults() {
		...
		foreach ($this->results as $row) {
			...
			if ($this->textposition == 1) {//text bottom
				echo '<div class="elx5_dateauthor">';
				echo $info_text;
				echo "</div>\n";
				if ($subtitle != '') {
					echo '<div class="elx5_zero">'.$subtitle."</div>\n";
				}
			} else {//text top
				if ($subtitle != '') {
					echo '<div class="elx5_dsspace">'.$subtitle."</div>\n";
				}
				echo '<div class="elx5_dateauthor elx5_zero">';
				echo $info_text;
				echo "</div>\n";
			}
	...
	private function getResultItemImage($image_relpath, $elxis, $eFiles) {
		if ($this->showimages == 0) { return ''; }

		if ($this->showimages == 1) {//always display an image
