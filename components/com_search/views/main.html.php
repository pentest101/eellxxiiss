<?php 
/**
* @version		$Id: main.html.php 2202 2019-04-10 17:41:17Z IOS $
* @package		Elxis
...
class mainSearchView {
	...
	private function addSearchProvider() {
		...
		echo '<div id="elx_addsearchengine" class="elx5_vlspace">'."\n";
		echo '<a href="javascript:void(null);" onclick="installSearchEngine(\''.$osd.'\');" title="'.$eLang->get('ADD_ENGINE_BROWSER').'">';
		echo '<img src="'.$eURI->secureBase().'/components/com_search/extra/browsers.png" alt="browsers" /> ';
