{
    ...
    "ERROR_CREATING_ZIP": "Σφάλμα δημιουργίας αρχείου Zip",
    "ERROR_OPENING_FILE": "Σφάλμα στο άνοιγμα του αρχείου.",
	"ERROR_RENAMING_DIRECTORY": "Σφάλμα κατά την μετονομασία του φακέλου %s σε %s.",
	"ERROR_RENAMING_FILE": "Σφάλμα κατά την μετονομασία του αρχείου %s σε %s.",
	...
	"fck_select_integration": "Η λειτουργία 'Επιλογή' χρησιμοποιείται μόνο σε συνεργασία με Κειμενογράφο.",
    ...
    "help_move": "Η χρήση '../' απαγορεύεται. Δεν μπορείτε να αποκτήσετε πρόσβαση στον πηγαίο φάκελο χρησιμοποιώντας '/'.",
    "items": "αντικείμενα",
    "kb": "kb",
    ...
    "support_fm": "Ο Filemanager είναι ελέυθερο λογισμικό. Παρακαλούμε υποστηρίξτε το!", 
    "upload": "Ανέβασμα", 
    "version": "έκδοση",
	"yes": "Ναι",
