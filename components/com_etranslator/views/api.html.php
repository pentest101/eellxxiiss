<?php 
/**
* @version		$Id: api.html.php 821 2012-01-08 11:39:23Z datahell $
* @package		Elxis
...
class apiEtranslatorView extends etranslatorView {
	...
	/**************************************/
	/* API LOAD JSON RESPONSE (ELXIS 4.X) */
	/**************************************/
	...
	/**************************************/
	/* API SAVE JSON RESPONSE (ELXIS 4.X) */
	/**************************************/
	...
	/****************************************/
	/* API DELETE JSON RESPONSE (ELXIS 4.X) */
	/****************************************/
