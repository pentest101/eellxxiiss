<?php 
/**
* @version		$Id: ldap.auth.php 2290 2019-05-17 16:43:02Z IOS $
* @package		Elxis
...
class ldapAuthentication {
	...
	public function loginForm() {
		...
		$action = $elxis->makeURL('user:login/ldap.html', '', true, false);
		...
		$form->addText('uname', '', $eLang->get('USERNAME'), array('required' => 'required', 'autocomplete' => 'off'));
	...
	private function ldapUser($username, $password) {
		...
		if (trim($udata->firstname) == '') { $udata->firstname = $udata->uname; }
