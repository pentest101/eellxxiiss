...
//5.0
$_lang['ICON_FONT'] = 'Иконка';
$_lang['ICON_FONT_DESC'] = 'При желании вы можете отобразить иконку шрифта (Elxis Font, Font Awesome и т.д.).';
$_lang['ONCLICK_DESC'] = 'Выполнить действие JavaScript по щелчку мыши или касанию';
$_lang['JSCODE'] = 'Код Javascript';
$_lang['JSCODE_DESC'] = 'Функция/код Javascript, который будет выполняться по клику';
