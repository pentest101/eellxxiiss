...
* @translator: Slavakov ( http://www.ekofarm.info )
*
...
//Elxis 4.1
$_lang['PERFORMANCE'] = 'Производительность';
$_lang['MINIFIER_CSSJS'] = 'CSS/Javascript minifier';
$_lang['MINIFIER_INFO'] = 'Elxis может объединять отдельные локальные файлы CSS и JS и, при необходимости, сжимать их. Унифицированный файл будет сохранен в кеше. 
Таким образом, вместо того, чтобы иметь несколько CSS/JS-файлов в разделе заголовка страницы, у вас будет один уменьшенный.';
$_lang['MOBILE_VERSION'] = 'Мобильная версия';
$_lang['MOBILE_VERSION_DESC'] = 'Включить мобильную версию для портативных устройств?';
//Elxis 4.2
$_lang['SEND_TEST_EMAIL'] = 'Отправить тестовое письмо';
$_lang['ONLINE_USERS'] = 'Онлайн для пользователей';
...
$_lang['LANG_DETECTION'] = 'Обнаружение Язык';
...
//Elxis 4.4
$_lang['DEFENDER_NOTIFS'] = 'Уведомления Защитник';
...
$_lang['ACCEPT_XFRAME'] = 'Принять X-Frame';
$_lang['DENY'] = 'Отрицать';
...
$_lang['UPDATED_AUTO'] = 'Обновлено автоматически';
$_lang['CHECK_IP_MOMENT'] = 'Проверьте момент IP';
...
$_lang['ONLY_ATTACKS'] = 'Только атаки';
$_lang['CRONJOBS_PROB'] = 'Cron jobs вероятность';
...
$_lang['EXACT'] = 'Точное';
//Elxis 4.6
$_lang['CONFIG_FOR_GMAIL'] = 'Конфигурация для Gmail';
$_lang['AUTH_METHOD'] = 'Метод аутентификации';
...
$_lang['PATHS_EXCLUDED_FSBK'] = 'Пути, исключенные из резервной копии файловой системы';
$_lang['EXCLUSIONS'] = 'Исключения';
//Elxis 5.0
...
$_lang['ALL_AVAILABLE'] = 'Все доступно';//translators help: "All available languages"
$_lang['NO_PROTECTION'] = 'Нет защиты';//translators help: No Elxis Defender filters enabled
$_lang['NEWER_VERSION_FOR'] = 'Есть более новые версии (%s) для %s';
$_lang['NEWER_VERSIONS_FOR'] = 'Есть более новые версии для %s';
$_lang['NEWER_VERSIONS_FOR_EXTS'] = 'There are newer versions for %s extensions';
$_lang['OUTDATED_ELXIS_UPDATE_TO'] = 'Вы используете устаревшую версию Elxis! Обновите как можно скорее до %s';
$_lang['NO_BACKUPS'] = 'У вас нет резервных копий!';
$_lang['LONGTIME_TAKE_BACKUP'] = 'You have a long time to take a site backup';
$_lang['DELETE_OLD_LOGS'] = 'Delete old log files';
$_lang['DEFENDER_IS_DISABLED'] = 'Elxis Defender отключен';
$_lang['REPO_DEF_PATH'] = 'Repository is at the default path';
$_lang['CHANGE_MAIL_TO_SMTP'] = 'Change PHP Mail to SMTP or else';
$_lang['DISABLE_MULTILINGUISM'] = 'Disable multilingualism';
$_lang['ENABLE_MULTILINGUISM'] = 'Enable multilingualism';
//Elxis 5.2
...
$_lang['EDIT_CODE'] = 'Редактировать код';
$_lang['EXCLUDED_IPS'] = 'Исключенные IPs';
