...
$_lang['CHECK_UPDATES'] = 'Проверка обновлений';
$_lang['TODAY'] = 'Сегодня';
$_lang['YESTERDAY'] = 'вчера';
//Elxis 4.3
$_lang['PUBLISH_ON'] = 'Опубликовать в';
$_lang['UNPUBLISHED'] = 'неопубликованный';
$_lang['UNPUBLISH_ON'] = 'Отменить публикацию';
...
$_lang['ARCHIVE'] = 'Архив';
$_lang['RUN_NOW'] = 'Запустить сейчас';
$_lang['LAST_RUN'] = 'Последняя казнь';
$_lang['SEC_AGO'] = '%s сек назад';
$_lang['MIN_SEC_AGO'] = '%s мин и %s сек назад';
$_lang['HOUR_MIN_AGO'] = '1 час и %s мин назад';
$_lang['HOURS_MIN_AGO'] = '%s часов и %s мин назад';
$_lang['CLICK_TOGGLE_STATUS'] = 'Нажмите для переключения статуса';
//Elxis 4.5
$_lang['IAMNOTA_ROBOT'] = 'Я не робот';
$_lang['VERIFY_NOROBOT'] = 'Пожалуйста, подтвердите, что вы не робот!';
$_lang['CHECK_FS'] = 'Файлы проверить';
//Elxis 5.0
$_lang['TOTAL_ITEMS'] = '%s пунктов';
$_lang['SEARCH_OPTIONS'] = 'Параметры поиска';
$_lang['FILTERS_HAVE_APPLIED'] = 'Фильтры были применены';
$_lang['FILTER_BY_ITEM'] = 'Фильтровать по этому пункту';
$_lang['REMOVE_FILTER'] = 'Удалить фильтр';
$_lang['TOTAL'] = 'Всего';
$_lang['OPTIONS'] = 'Параметры';
$_lang['DISABLE'] = 'Запрещено';
$_lang['REMOVE'] = 'Удалить';
$_lang['ADD_ALL'] = 'Добавить все';
$_lang['TOMORROW'] = 'Завтра';
$_lang['NOW'] = 'Сейчас';
$_lang['MIN_AGO'] = '1 минуту назад';
$_lang['MINS_AGO'] = '%s мин. назад';
$_lang['HOUR_AGO'] = '1 час назад';
$_lang['HOURS_AGO'] = '%s час. назад';
$_lang['IN_SEC'] = 'In %s сек.';
$_lang['IN_MINUTE'] = 'Через 1 минуту';
$_lang['IN_MINUTES'] = 'Через %s мин.';
$_lang['IN_HOUR'] = 'Через 1 час';
$_lang['IN_HOURS'] = 'Через %s час.';
$_lang['OTHER'] = 'Другой';
$_lang['DELETE_CURRENT_IMAGE'] = 'Удалить текущее изображение';
$_lang['NO_IMAGE_FILE'] = 'Нет файла изображения!';
