...
//Elxis 5.0
$_lang['OTHER_LANGS'] = 'Другие языки';
$_lang['OTHER_LANGS_DESC'] = 'Какие другие языки, кроме языка по умолчанию, вы хотите быть доступным?';
$_lang['ALL_LANGS'] = 'Все';
$_lang['NONE_LANGS'] = 'Никто';
$_lang['REMOVE'] = 'Удалить';
$_lang['CONFIG_EMAIL_DISPATCH'] = 'Настроить рассылку электронной почты (необязательно)';
$_lang['SEND_METHOD'] = 'Отправить метод';
$_lang['RECOMMENDED'] = 'рекомендуемые';
$_lang['SECURE_CONNECTION'] = 'Безопасное соединение';
$_lang['AUTH_REQUIRED'] = 'Требуется авторизация';
$_lang['AUTH_METHOD'] = 'Метод аутентификации';
$_lang['DEFAULT_METHOD'] = 'По умолчанию';
