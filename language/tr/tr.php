...
$_lang['MORE'] = 'Devamı';
//Elxis 4.2
$_lang['TRANSLATIONS'] = 'Çeviriler';
$_lang['CHECK_UPDATES'] = 'Güncelleştirmeleri denetleyin';
$_lang['TODAY'] = 'Bugün';
$_lang['YESTERDAY'] = 'Dün';
//Elxis 4.3
$_lang['PUBLISH_ON'] = 'Yayınlayın';
$_lang['UNPUBLISHED'] = 'Yayınlanmamış';
$_lang['UNPUBLISH_ON'] = 'Yayından';
$_lang['SCHEDULED_CRON_DIS'] = 'There are %s scheduled items but Cron Jobs are disabled!';
$_lang['CRON_DISABLED'] = 'Cron Jobs pasif!';
$_lang['ARCHIVE'] = 'Arşiv';
$_lang['RUN_NOW'] = 'Şimdi Yürüt';
$_lang['LAST_RUN'] = 'Son yürütme';
$_lang['SEC_AGO'] = '%s sn önce';
$_lang['MIN_SEC_AGO'] = '%s dk ve %s sn önce';
$_lang['HOUR_MIN_AGO'] = '1 saat ve %s dk önce';
$_lang['HOURS_MIN_AGO'] = '%s saat ve %s dk önce';
$_lang['CLICK_TOGGLE_STATUS'] = 'Durumunu değiştirmek için tıklayın';
//Elxis 4.5
$_lang['IAMNOTA_ROBOT'] = 'Ben robot değilim';
$_lang['VERIFY_NOROBOT'] = 'Bir robot olmadığınızı teyit edin!';
$_lang['CHECK_FS'] = 'Dosyaları kontrol edin';
//Elxis 5.0
$_lang['TOTAL_ITEMS'] = '%s öğeler';
$_lang['SEARCH_OPTIONS'] = 'Arama seçenekleri';
$_lang['FILTERS_HAVE_APPLIED'] = 'Filtreler uygulandı';
$_lang['FILTER_BY_ITEM'] = 'Bu öğeye göre filtrele';
$_lang['REMOVE_FILTER'] = 'Filtreyi kaldır';
$_lang['TOTAL'] = 'Genel Toplam';
$_lang['OPTIONS'] = 'Seçenekler';
$_lang['DISABLE'] = 'Devre dışı';
$_lang['REMOVE'] = 'Kaldır';
$_lang['ADD_ALL'] = 'Hepsini ekle';
$_lang['TOMORROW'] = 'Yarın';
$_lang['NOW'] = 'Şimdi';
$_lang['MIN_AGO'] = '1 dakika önce';
$_lang['MINS_AGO'] = '%s dakika önce';
$_lang['HOUR_AGO'] = '1 saat önce';
$_lang['HOURS_AGO'] = '%s saat önce';
$_lang['IN_SEC'] = '%s saniyede';
$_lang['IN_MINUTE'] = '1 dakikada';
$_lang['IN_MINUTES'] = '%s dakikada';
$_lang['IN_HOUR'] = '1 saatte';
$_lang['IN_HOURS'] = '%s saatte';
$_lang['OTHER'] = 'Diğer';
$_lang['DELETE_CURRENT_IMAGE'] = 'Mevcut resmi sil';
$_lang['NO_IMAGE_FILE'] = 'Resim dosyası yok!';
$_lang['SELECT_FILE'] = 'Dosya Seç';
