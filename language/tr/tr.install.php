...
//Elxis 5.0
$_lang['OTHER_LANGS'] = 'Diğer diller';
$_lang['OTHER_LANGS_DESC'] = 'Varsayılan olarak, başka hangi dilleri kullanmak istersiniz?';
$_lang['ALL_LANGS'] = 'Hepsi';
$_lang['NONE_LANGS'] = 'Hiçbiri';
$_lang['REMOVE'] = 'Kaldır';
$_lang['CONFIG_EMAIL_DISPATCH'] = 'E-posta gönderimini yapılandır (isteğe bağlı)';
$_lang['SEND_METHOD'] = 'Gönderi yöntemi';
$_lang['RECOMMENDED'] = 'Tavsiye edilen';
$_lang['SECURE_CONNECTION'] = 'Güvenli bağlantı';
$_lang['AUTH_REQUIRED'] = 'Kimlik doğrulama gerekli';
$_lang['AUTH_METHOD'] = 'Kimlik doğrulama yöntemi';
$_lang['DEFAULT_METHOD'] = 'Varsayılan';
