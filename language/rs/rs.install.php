...
//Elxis 5.0
$_lang['OTHER_LANGS'] = 'Остали језици';
$_lang['OTHER_LANGS_DESC'] = 'Који језици ће бити доступни, осим основног?';
$_lang['ALL_LANGS'] = 'Сви';
$_lang['NONE_LANGS'] = 'Ниједан';
$_lang['REMOVE'] = 'Уклони';
$_lang['CONFIG_EMAIL_DISPATCH'] = 'Конфигуришите слање email порука (опционо)';
$_lang['SEND_METHOD'] = 'Начин слања';
$_lang['RECOMMENDED'] = 'препоручено';
$_lang['SECURE_CONNECTION'] = 'Сигурна веза';
$_lang['AUTH_REQUIRED'] = 'Аутентикација је обавезна';
$_lang['AUTH_METHOD'] = 'Начин аутентикације';
$_lang['DEFAULT_METHOD'] = 'Уобичајено';
