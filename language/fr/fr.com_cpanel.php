...
* @translator: Francis Dionne Canada ( https://www.elxis.org )
*
...
//Elxis 4.2
$_lang['SEND_TEST_EMAIL'] = 'Envoyer email de test';
$_lang['ONLINE_USERS'] = 'Online pour les utilisateurs';
...
$_lang['LANG_DETECTION'] = 'Détection de la langue';
...
//Elxis 4.4
$_lang['DEFENDER_NOTIFS'] = 'Notifications Defender';
...
$_lang['ACCEPT_XFRAME'] = 'Accepter X-Frame';
$_lang['DENY'] = 'Nier';
$_lang['SAMEORIGIN'] = 'Même origine';
$_lang['ALLOW_FROM'] = 'Autoriser dans';
...
$_lang['CHECK_IP_MOMENT'] = 'Vérifiez instant IP';
...
$_lang['SECURITY'] = 'Sécurité';
$_lang['EVERYTHING'] = 'Tout';
$_lang['ONLY_ATTACKS'] = 'Seuls les attaques';
$_lang['CRONJOBS_PROB'] = 'Cron jobs probabilité';
...
$_lang['SEO_TITLES_MATCH'] = 'SEO Titres correspondance';
...
$_lang['EXACT'] = 'Exact';
//Elxis 4.6
$_lang['CONFIG_FOR_GMAIL'] = 'Configuration pour Gmail';
...
$_lang['PATHS_EXCLUDED_FSBK'] = 'Chemins exclus de la sauvegarde du système de fichiers';
$_lang['EXCLUSIONS'] = 'Exclusions';
//Elxis 5.0
...
$_lang['DEPRECATED'] = 'Obsolète';
$_lang['ALL_AVAILABLE'] = 'Tous disponibles';//translators help: "All available languages"
$_lang['NO_PROTECTION'] = 'Pas de protection';//translators help: No Elxis Defender filters enabled
$_lang['NEWER_VERSION_FOR'] = 'Il existe une version plus récente (%s) pour %s';
$_lang['NEWER_VERSIONS_FOR'] = 'Il existe de nouvelles versions pour %s';
$_lang['NEWER_VERSIONS_FOR_EXTS'] = 'Il existe de nouvelles versions pour %s extensions';
$_lang['OUTDATED_ELXIS_UPDATE_TO'] = 'Vous utilisez une version obsolète d Elxis! Mettre à jour dès que possible à %s';
$_lang['NO_BACKUPS'] = 'Vous avez pas de sauvegardes!';
$_lang['LONGTIME_TAKE_BACKUP'] = 'Vous avez beaucoup de temps pour effectuer une sauvegarde de site';
$_lang['DELETE_OLD_LOGS'] = 'Supprimer les anciens fichiers journaux';
$_lang['DEFENDER_IS_DISABLED'] = 'Elxis Defender est désactivé';
$_lang['REPO_DEF_PATH'] = 'Le référentiel est dans le chemin par défaut';
$_lang['CHANGE_MAIL_TO_SMTP'] = 'Modifiez le PHP Mail en SMTP ou autre';
$_lang['DISABLE_MULTILINGUISM'] = 'Désactiver le multilinguisme';
$_lang['ENABLE_MULTILINGUISM'] = 'Activer le multilinguisme';
//Elxis 5.2
$_lang['NOTFOUND'] = 'Pas trouvé';
...
$_lang['EDIT_CODE'] = 'Modifier le code';
$_lang['EXCLUDED_IPS'] = 'IP exclues';
