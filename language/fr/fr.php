...
$_lang['CHECK_UPDATES'] = 'Vérifier les mises à jour';
$_lang['TODAY'] = 'Aujourd\'hui';
$_lang['YESTERDAY'] = 'Hier';
//Elxis 4.3
$_lang['PUBLISH_ON'] = 'Publier le';
$_lang['UNPUBLISHED'] = 'Inédit';
$_lang['UNPUBLISH_ON'] = 'Dépublier le';
...
$_lang['ARCHIVE'] = 'Archives';
$_lang['RUN_NOW'] = 'Εxécuter maintenant';
$_lang['LAST_RUN'] = 'Dernière exécution';
$_lang['SEC_AGO'] = 'Il ya %s sec';
$_lang['MIN_SEC_AGO'] = 'Il ya %s min et %s sec';
$_lang['HOUR_MIN_AGO'] = 'Il ya 1 heure et %s min';
$_lang['HOURS_MIN_AGO'] = 'Il ya %s heures et %s min';
$_lang['CLICK_TOGGLE_STATUS'] = 'Cliquer ici pour basculer état';
//Elxis 4.5
$_lang['IAMNOTA_ROBOT'] = 'Je ne suis pas un robot';
$_lang['VERIFY_NOROBOT'] = 'S\'il vous plaît confirmer que vous n\'êtes pas un robot!';
$_lang['CHECK_FS'] = 'Fichiers vérifier';
//Elxis 5.0
$_lang['TOTAL_ITEMS'] = '%s éléments ';
$_lang['SEARCH_OPTIONS'] = 'Options de recherche';
$_lang['FILTERS_HAVE_APPLIED'] = 'Les filtres ont été appliqués';
$_lang['FILTER_BY_ITEM'] = 'Filtrer par cet élément';
$_lang['REMOVE_FILTER'] = 'Supprimer le filtre';
$_lang['TOTAL'] = 'Total';
$_lang['OPTIONS'] = 'Options';
$_lang['DISABLE'] = 'Désactiver';
$_lang['REMOVE'] = 'Supprimer';
$_lang['ADD_ALL'] = 'Ajouter tout';
$_lang['TOMORROW'] = 'Demain';
$_lang['NOW'] = 'Maintenant';
$_lang['MIN_AGO'] = 'Il y a 1 minute';
$_lang['MINS_AGO'] = 'Il y a %s minutes';
$_lang['HOUR_AGO'] = 'Il y a 1 heure';
$_lang['HOURS_AGO'] = 'Il y a %s heures';
$_lang['IN_SEC'] = 'Dans %s sec';
$_lang['IN_MINUTE'] = 'Dans 1 minute';
$_lang['IN_MINUTES'] = 'Dans %s minute';
$_lang['IN_HOUR'] = 'Dans 1 heure';
$_lang['IN_HOURS'] = 'Dans %s heures';
$_lang['OTHER'] = 'Autre';
$_lang['DELETE_CURRENT_IMAGE'] = 'Supprimer l image actuelle';
$_lang['NO_IMAGE_FILE'] = 'Pas de fichier image!';
$_lang['SELECT_FILE'] = 'Choisir un fichier';
