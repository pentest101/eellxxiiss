...
//Elxis 5.0
$_lang['OTHER_LANGS'] = 'Autres langues';
$_lang['OTHER_LANGS_DESC'] = 'Quelles autres langues, à part la langue par défaut, vous souhaitez être disponible?';
$_lang['ALL_LANGS'] = 'Tous';
$_lang['NONE_LANGS'] = 'Aucun';
$_lang['REMOVE'] = 'Supprimer';
$_lang['CONFIG_EMAIL_DISPATCH'] = 'Configurer l envoi du courrier électronique (facultatif)';
$_lang['SEND_METHOD'] = 'Méthode d envoi';
$_lang['RECOMMENDED'] = 'recommandé';
$_lang['SECURE_CONNECTION'] = 'Connexion sécurisée';
$_lang['AUTH_REQUIRED'] = 'Authentification requise';
$_lang['AUTH_METHOD'] = 'Méthode d authentification';
$_lang['DEFAULT_METHOD'] = 'Par défaut';
