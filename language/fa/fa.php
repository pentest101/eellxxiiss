...
$_lang['MORE'] = 'بیشتر';
//Elxis 4.2
$_lang['TRANSLATIONS'] = 'ترجمه';
$_lang['CHECK_UPDATES'] = 'به روز رسانی را بررسی کنید';
$_lang['TODAY'] = 'امروز';
$_lang['YESTERDAY'] = 'دیروز';
//Elxis 4.3
$_lang['PUBLISH_ON'] = 'انتشار در';
$_lang['UNPUBLISHED'] = 'منتشر نشده';
$_lang['UNPUBLISH_ON'] = 'انتشار در';
...
$_lang['ARCHIVE'] = 'بایگانی';
$_lang['RUN_NOW'] = 'Run now';
$_lang['LAST_RUN'] = 'Last run';
$_lang['SEC_AGO'] = '%s ثانیه پیش.';
...
//Elxis 4.5
$_lang['IAMNOTA_ROBOT'] = 'من یک ربات نمی';
$_lang['VERIFY_NOROBOT'] = 'لطفا تأیید کنید که یک ربات نمی کند!';
$_lang['CHECK_FS'] = 'فایل های تیک بزنید';
//Elxis 5.0
$_lang['TOTAL_ITEMS'] = '%s items';
$_lang['SEARCH_OPTIONS'] = 'Search options';
$_lang['FILTERS_HAVE_APPLIED'] = 'Filters have been applied';
$_lang['FILTER_BY_ITEM'] = 'Filter by this item';
$_lang['REMOVE_FILTER'] = 'Remove filter';
$_lang['TOTAL'] = 'Total';
...
$_lang['NOW'] = 'Now';
$_lang['MIN_AGO'] = '1 minute ago';
$_lang['MINS_AGO'] = '%s minutes ago';
$_lang['HOUR_AGO'] = '1 hour ago';
$_lang['HOURS_AGO'] = '%s hours ago';
$_lang['IN_SEC'] = 'In %s sec';
$_lang['IN_MINUTE'] = 'In 1 minute';
$_lang['IN_MINUTES'] = 'In %s minute';
$_lang['IN_HOUR'] = 'In 1 hour';
$_lang['IN_HOURS'] = 'In %s hours';
$_lang['OTHER'] = 'Other';
$_lang['DELETE_CURRENT_IMAGE'] = 'Delete current image';
$_lang['NO_IMAGE_FILE'] = 'No image file!';
