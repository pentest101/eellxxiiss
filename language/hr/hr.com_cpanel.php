...
Dakle, umjesto da imate više CSS / JS datoteka u odjeljku glave stranica imat ćete samo jedan minificiran.';
$_lang['MOBILE_VERSION'] = 'Mobilna verzija';
$_lang['MOBILE_VERSION_DESC'] = 'Omogučite mobile-friendly verziju za mobilne uređaje?';
//Elxis 4.2
$_lang['SEND_TEST_EMAIL'] = 'Pošalji testni e-mail';
$_lang['ONLINE_USERS'] = 'Online za korisnike';
$_lang['CRONJOBS'] = 'Cron poslovi';
$_lang['CRONJOBS_INFO'] = 'Omogućite cron poslove ako želite pokrenuti automatizirane zadatke kao što je objavljivanje raspoređenih članaka.';
$_lang['LANG_DETECTION'] = 'Prepoznavanje jezika';
$_lang['LANG_DETECTION_INFO'] = 'Otkrivanje i preusmjeravanje jezika na odgovarajuću jezičnu verziju stranice pri prvom posjetu naslovnoj stranici.';
//Elxis 4.4
$_lang['DEFENDER_NOTIFS'] = 'Zaštitnika obavijesti';
$_lang['XFRAMEOPT_HELP'] = 'HTTP zaglavlje koje kontrolira hoće li preglednik prihvatiti ili odbiti prikazivanje stranica s tog mjesta unutar okvira. Pomaže u izbjegavanju napada klikanjem.';
$_lang['ACCEPT_XFRAME'] = 'Prihvatiti X-Frame';
$_lang['DENY'] = 'Odbij';
$_lang['SAMEORIGIN'] = 'Isto podrijetlo';
$_lang['ALLOW_FROM'] = 'Dopusti od';
$_lang['ALLOW_FROM_ORIGIN'] = 'Dopusti iz podrijetla';
$_lang['CONTENT_SEC_POLICY'] = 'Politika sigurnosti sadržaja';
$_lang['IP_RANGES'] = 'IP Rang';
$_lang['UPDATED_AUTO'] = 'Ažurira se automatski';
$_lang['CHECK_IP_MOMENT'] = 'Provjerite IP trenutak';
$_lang['BEFORE_LOAD_ELXIS'] = 'Prije učitavanja Elxis jezgre';
$_lang['AFTER_LOAD_ELXIS'] = 'Poslje učitavanja Elxis jezgre';
$_lang['CHECK_IP_MOMENT_HELP'] = 'PRIJE: Defender provjerava IP adrese na svaki klik. Loše IP adrese ne dosežu Elxis jezgru.
	NAKON: Defender provjerava IP adrese samo jednom po sesiji (poboljšanje izvedbe). Loše IP adrese stižu do jezgre Elxisa prije nego što se blokiraju.';
$_lang['SECURITY'] = 'Sigurnost';
$_lang['EVERYTHING'] = 'Sve';
$_lang['ONLY_ATTACKS'] = 'Samo napada';
$_lang['CRONJOBS_PROB'] = 'Cron jobs vjerojatnosti';
$_lang['CRONJOBS_PROB_INFO'] = 'Postotak vjerojatnosti izvršavanja Cron poslova za svakog korisnika klik. Utječe samo na cron poslove koje je Elxis izvršio interno. Za najbolju izvedbu trebao bi biti veći broj posjetitelja vaše web-lokacije. Zadana vrijednost je 10%.';
$_lang['EXTERNAL'] = 'Vanjski';
$_lang['SEO_TITLES_MATCH'] = 'SEO Naslovi susret';
$_lang['SEO_TITLES_MATCH_HELP'] = 'Kontrolira generiranje SEO naslova iz normalnih naslova. Točan stvara SEO naslove koji se točno podudaraju s originalnim naslovima.';
$_lang['EXACT'] = 'Točan';
//Elxis 4.6
$_lang['CONFIG_FOR_GMAIL'] = 'Konfiguracija za Gmail';
$_lang['AUTH_METHOD'] = 'Metoda provjere autentičnosti';
$_lang['DEFAULT'] = 'Zadano';
$_lang['BACKUP_EXCLUDE_PATHS_HELP'] = 'Neke mape možete izuzeti iz postupka kopiranja datotečnog sustava. Ovo je iznimno korisno ako imate veliki datotečni sustav, a sigurnosna kopija ne uspijeva dovršiti zbog problema s memorijom. Ispod mapa koje želite izuzeti navedite njihove relativne putove. Primjer: media/videos/';
...
$_lang['DEPRECATED'] = 'Obustavljeno';
$_lang['ALL_AVAILABLE'] = 'Sve je dostupno';//translators help: "All available languages"
$_lang['NO_PROTECTION'] = 'Bez zaštite';//translators help: No Elxis Defender filters enabled
$_lang['NEWER_VERSION_FOR'] = 'Postoji novija inačica (%s) za %s';
$_lang['NEWER_VERSIONS_FOR'] = 'Postoje nove verzije za %s';
$_lang['NEWER_VERSIONS_FOR_EXTS'] = 'Postoje nove verzije za %s ekstenzije';
$_lang['OUTDATED_ELXIS_UPDATE_TO'] = 'Koristite zastarjelu Elxis verziju! Ažurirajte što je prije moguće %s';
$_lang['NO_BACKUPS'] = 'Nemate sigurnosnih kopija!';
$_lang['LONGTIME_TAKE_BACKUP'] = 'Imate vremena da napravite sigurnosnu kopiju web-lokacije';
$_lang['DELETE_OLD_LOGS'] = 'Izbrišite stare datoteke dnevnika';
$_lang['DEFENDER_IS_DISABLED'] = 'Elxis Defender je onemogućen';
$_lang['REPO_DEF_PATH'] = 'Spremište je na zadanom putu';
$_lang['CHANGE_MAIL_TO_SMTP'] = 'Promijenite PHP Mail na SMTP ili na drugi način';
$_lang['DISABLE_MULTILINGUISM'] = 'Onemogući višejezičnost';
$_lang['ENABLE_MULTILINGUISM'] = 'Omogućite višejezičnost';
//Elxis 5.2
