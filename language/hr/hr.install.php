...
//Elxis 5.0
$_lang['OTHER_LANGS'] = 'Drugi jezici';
$_lang['OTHER_LANGS_DESC'] = 'Koji drugi jezici, osim zadane, želite biti dostupni?';
$_lang['ALL_LANGS'] = 'Svi';
$_lang['NONE_LANGS'] = 'Nijedan';
$_lang['REMOVE'] = 'Ukloniti';
$_lang['CONFIG_EMAIL_DISPATCH'] = 'Konfiguriraj slanje e-pošte (izborno)';
$_lang['SEND_METHOD'] = 'Metoda slanja';
$_lang['RECOMMENDED'] = 'preporuča';
$_lang['SECURE_CONNECTION'] = 'Sigurna veza';
$_lang['AUTH_REQUIRED'] = 'Potrebna provjera';
$_lang['AUTH_METHOD'] = 'Metoda autentifikacije';
$_lang['DEFAULT_METHOD'] = 'Zadano';
