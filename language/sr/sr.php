...
$_lang['MORE'] = 'I još';
//Elxis 4.2
$_lang['TRANSLATIONS'] = 'Prevodi';
$_lang['CHECK_UPDATES'] = 'Proverite ispravke';
$_lang['TODAY'] = 'Danas';
$_lang['YESTERDAY'] = 'juče';
//Elxis 4.3
$_lang['PUBLISH_ON'] = 'Objavljivanje na';
$_lang['UNPUBLISHED'] = 'neobjavljen';
$_lang['UNPUBLISH_ON'] = 'Povući na';
$_lang['SCHEDULED_CRON_DIS'] = 'Ima %s zakazanih stavki ali su ponavljani poslovi iskljuleni!';
$_lang['CRON_DISABLED'] = 'Ponavljani poslovi su isključeni!';
$_lang['ARCHIVE'] = 'Arhiva';
$_lang['RUN_NOW'] = 'Izvršite sada';
$_lang['LAST_RUN'] = 'Poslednji izvršenje';
$_lang['SEC_AGO'] = '%s sek ranije';
$_lang['MIN_SEC_AGO'] = '%s min i %s sek ranije';
$_lang['HOUR_MIN_AGO'] = '1 sat i %s min ranije';
$_lang['HOURS_MIN_AGO'] = '%s sati i %s min ranije';
$_lang['CLICK_TOGGLE_STATUS'] = 'Kliknite da biste prebacili status';
//Elxis 4.5
$_lang['IAMNOTA_ROBOT'] = 'Ja nisam robot';
$_lang['VERIFY_NOROBOT'] = 'Molimo Vas da potvrdite da niste robot!';
$_lang['CHECK_FS'] = 'Provera';
//Elxis 5.0
$_lang['TOTAL_ITEMS'] = '%s stavki';
$_lang['SEARCH_OPTIONS'] = 'Opcije pretrage';
$_lang['FILTERS_HAVE_APPLIED'] = 'Filteri su primeljeni';
$_lang['FILTER_BY_ITEM'] = 'Filtriraj po ovoj stavci';
$_lang['REMOVE_FILTER'] = 'Ukloni filter';
$_lang['TOTAL'] = 'Ukupno';
...
$_lang['NOW'] = 'Sada';
$_lang['MIN_AGO'] = '1 minut ranije';
$_lang['MINS_AGO'] = '%s minuta ranije';
$_lang['HOUR_AGO'] = '1 sat ranije';
$_lang['HOURS_AGO'] = '%s sati ranije';
$_lang['IN_SEC'] = 'Za %s sekundi';
$_lang['IN_MINUTE'] = 'Za 1 minut';
$_lang['IN_MINUTES'] = 'Za %s minuta';
$_lang['IN_HOUR'] = 'Ѕa 1 sat';
$_lang['IN_HOURS'] = 'Za %s sati';
$_lang['OTHER'] = 'Drugo';
$_lang['DELETE_CURRENT_IMAGE'] = 'Brisanje aktuelne slike';
$_lang['NO_IMAGE_FILE'] = 'Nema slike!';
$_lang['SELECT_FILE'] = 'Izbor slike';
