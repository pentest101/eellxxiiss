...
$_lang['SITE_LANGS'] = 'Jezici';
$_lang['SITE_LANGS_DESC'] = 'Obično su svi jezici dostupni na pročelju sajta. Ovo možete promeniti 
	izborom jezika koje želite da učinite dostupnim.';
//Elxis 4.1
$_lang['PERFORMANCE'] = 'Performanse';
$_lang['MINIFIER_CSSJS'] = 'CSS/Javascript minifier';
$_lang['MINIFIER_INFO'] = 'Elxis može da objedini CSS i JS fajlove i kompresuje ih. Objedinjeni fjlovi će biti keširani. 
Zato, umesto da imate nekoliko CSS/JS, imaćete samo jedan i to minimizovan.';
$_lang['MOBILE_VERSION'] = 'Mobilna verzija';
$_lang['MOBILE_VERSION_DESC'] = 'Uključite mobilnu verziju za ručne uređaje?';
//Elxis 4.2
$_lang['SEND_TEST_EMAIL'] = 'Pošalji probni email';
$_lang['ONLINE_USERS'] = 'Online za korisnike';
$_lang['CRONJOBS'] = 'Ponavljani zadaci';
$_lang['CRONJOBS_INFO'] = 'Podesite ponavljane zadatke kako bi se oni automatski obavljali (npr. objavljivanje članaka).';
$_lang['LANG_DETECTION'] = 'Otkrivanje jezika';
$_lang['LANG_DETECTION_INFO'] = 'Probaće da otkrije maternji jezik korisnika, a zatim usmeriti ga na odgovarajuću verziju sajta.';
//Elxis 4.4
$_lang['DEFENDER_NOTIFS'] = 'Obaveštenja zaštitnika';
$_lang['XFRAMEOPT_HELP'] = 'HTTP header koji kontroliše da li će pregledač prihvatiti stranu na kojoj se nalazi sadžaj u nutar frame. Pomaže u sprečavanju odreženih napada na sajt.';
$_lang['ACCEPT_XFRAME'] = 'Prihvati X-Frame';
$_lang['DENY'] = 'Odbij';
$_lang['SAMEORIGIN'] = 'Isti izvor';
$_lang['ALLOW_FROM'] = 'Dozvoli od';
$_lang['ALLOW_FROM_ORIGIN'] = 'Dozvoli sa izvora';
$_lang['CONTENT_SEC_POLICY'] = 'Sigurnosna politika sadržaja';
$_lang['IP_RANGES'] = 'IP opseg';
$_lang['UPDATED_AUTO'] = 'Automatsko ažuriranje';
$_lang['CHECK_IP_MOMENT'] = 'Trenutak IP provere.';
$_lang['BEFORE_LOAD_ELXIS'] = 'Pre učitavanja Elxis jezgra';
$_lang['AFTER_LOAD_ELXIS'] = 'Nakon učitavanja Elxis jezgra';
$_lang['CHECK_IP_MOMENT_HELP'] = 'PRE: Defender proverava IPs za svaki klik. Zloćudni IP ne stiže do Elxis jezgra. 
	NAKON: Defender proverava IPs jednom po sesiji (poboljšane performanse). Zloćudni IP dolazi do Elxis jezgra, pre nego što bude blokiran.';
$_lang['SECURITY'] = 'Bezbednost';
$_lang['EVERYTHING'] = 'Sve';
$_lang['ONLY_ATTACKS'] = 'Samo napadi';
$_lang['CRONJOBS_PROB'] = 'Cron jobs verovatnoća';
$_lang['CRONJOBS_PROB_INFO'] = 'Procenat verovatnoće izvršavanja ponavljanih zadataka za svaki korisnički klik. Utiče samo na ponavljane zadatke koje izvršava Elxis. Što više posetilaca imatee, postavite ovu vrednost na niže. Uobičajena vrednost je 10%.';
$_lang['EXTERNAL'] = 'Spoljni';
$_lang['SEO_TITLES_MATCH'] = 'SEO naslovi';
$_lang['SEO_TITLES_MATCH_HELP'] = 'Kontroliše pravljenje SEO naslova od običnih naslova. Doslovno pravi SEO naslove koji glase doslovno kao originalni naslov, samo transliterovano.';
$_lang['EXACT'] = 'Doslovno';
//Elxis 4.6
$_lang['CONFIG_FOR_GMAIL'] = 'Konfiguracija za Gmail';
$_lang['AUTH_METHOD'] = 'Metod autentikacije';
$_lang['DEFAULT'] = 'Uobičajeno';
$_lang['BACKUP_EXCLUDE_PATHS_HELP'] = 'Možete isključiti određene foldere iz bekapa sistema. Ovo je naročito korisno  
	ukoliko imate mnogo fajlova i bekap ne uspe zbog problema s memorijom. Izaberite foldere koje želite da isključite, 
	tako što ćete dati njihove putanje. Primer: media/videos/';
$_lang['PATHS_EXCLUDED_FSBK'] = 'Putanje koje su isključene iz sigurnosne kopije datoteka';
$_lang['EXCLUSIONS'] = 'Isključenja';
//Elxis 5.0
$_lang['BACKUP_FOLDER_TABLE_TIP'] = 'Za bekap možete izabrati celu Elxis instalaciju ili specifičan folder. 
	Za bazu možete izabrati celu bazu ili određenu tabelu. Za slučaj da dobijete timeout ili memory errors tokom bekapa (posebno 
	na velikim sajtovima) izaberite bekap pojedinačnih foldera, odnosno, tabela.';
$_lang['FOLDER'] = 'Folder';
$_lang['TABLE'] = 'Tabela';
$_lang['INACTIVE'] = 'Neaktovno';
$_lang['DEPRECATED'] = 'Zastarelo';
$_lang['ALL_AVAILABLE'] = 'Svi dostupni';//translators help: "All available languages"
$_lang['NO_PROTECTION'] = 'Bez zaštite';//translators help: No Elxis Defender filters enabled
$_lang['NEWER_VERSION_FOR'] = 'Postoji novija verzija (%s) za %s';
$_lang['NEWER_VERSIONS_FOR'] = 'Postoji novija verzija %s';
$_lang['NEWER_VERSIONS_FOR_EXTS'] = 'Novije verzije postoje za %s ekstenzije';
$_lang['OUTDATED_ELXIS_UPDATE_TO'] = 'Imate zastarelu Elxis verziju! Ažurirajte što pre na verziju %s';
$_lang['NO_BACKUPS'] = 'Ne postoje bekapi!';
$_lang['LONGTIME_TAKE_BACKUP'] = 'Potrebno je mnogo vremena za bekap celog sajta';
$_lang['DELETE_OLD_LOGS'] = 'Obrišite stare zapise';
$_lang['DEFENDER_IS_DISABLED'] = 'Elxis Defender je isključen';
$_lang['REPO_DEF_PATH'] = 'Spremište je na uobičajenoj putanji';
$_lang['CHANGE_MAIL_TO_SMTP'] = 'Promeni PHP Mail u SMTP ili drugo';
$_lang['DISABLE_MULTILINGUISM'] = 'Isključi višejezičnost';
$_lang['ENABLE_MULTILINGUISM'] = 'Omogući višejezičnost';
//Elxis 5.2
