...
//Elxis 5.0
$_lang['OTHER_LANGS'] = 'Ostali jezici';
$_lang['OTHER_LANGS_DESC'] = 'Koji jezici će biti dostupni, osim osnovnog?';
$_lang['ALL_LANGS'] = 'Svi';
$_lang['NONE_LANGS'] = 'Nijedan';
$_lang['REMOVE'] = 'Ukloni';
$_lang['CONFIG_EMAIL_DISPATCH'] = 'Konfigurišite slanje email poruka (opciono)';
$_lang['SEND_METHOD'] = 'Način slanja';
$_lang['RECOMMENDED'] = 'preporučeno';
$_lang['SECURE_CONNECTION'] = 'Sigurna veza';
$_lang['AUTH_REQUIRED'] = 'Autentikacija je obavezna';
$_lang['AUTH_METHOD'] = 'Način autentikacije';
$_lang['DEFAULT_METHOD'] = 'Uobičajeno';
