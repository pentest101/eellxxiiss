...
$_lang['THANKS_USING_ELXIS'] = 'Grazie per usare Elxis CMS.';
//Elxis 5.0
$_lang['OTHER_LANGS'] = 'Altre lingue';
$_lang['OTHER_LANGS_DESC'] = 'Quali altre lingue, eccetto quelle di default, vuoi rendere disponibili?';
$_lang['ALL_LANGS'] = 'Tutte';
$_lang['NONE_LANGS'] = 'Nessuno';
$_lang['REMOVE'] = 'Rimuovi';
$_lang['CONFIG_EMAIL_DISPATCH'] = 'Configura invio e-mail (facoltativo)';
$_lang['SEND_METHOD'] = 'Metodo invio';
$_lang['RECOMMENDED'] = 'raccomandato';
$_lang['SECURE_CONNECTION'] = 'Connessione sicura';
$_lang['AUTH_REQUIRED'] = 'Autenticazione richiesta';
