...
$_lang['LOG'] = 'Log';
$_lang['LOG_INFO'] = 'Livello di errore del log. Seleziona quali errori desideri vengono segnalati da Elxis nel file 
	log di sistema (repository/logs/).';
$_lang['ALERT'] = 'Allarme';
...
$_lang['ALLOWED_DOMAIN_INFO'] = 'Scrivi un nome dominio (es.: elxis.org) solo per il quale il sistema accetterà gli 
	indirizzi e-mail di registrazione.';
...
$_lang['ELXIS_DEFENDER_INFO'] = 'Elxis defender protegge il tuo sito web dagli attacchi di iniezione XSS e SQL. 
	...
	un attacco e un accesso (log-it). È possibile selezionare quale tipo di filtri da applicare o addirittura bloccare i file di 
	sistema più importanti per modifiche non autorizzate. Più sono i filtri abilitati più lento sarà il vostro sito. Si consiglia 
	l´attivazione delle opzioni G, C e F. Consultare la documentazione di Elxis per saperne di più.';
...
$_lang['USER_LOGGED_OUT'] = 'L´utente è stato Disconnesso!';
...
$_lang['FILE_CNOT_DELETE'] = 'Questo file non può essere eliminato!';
...
//Elxis 4.1
$_lang['PERFORMANCE'] = 'Prestazione';
$_lang['MINIFIER_CSSJS'] = 'CSS/Javascript minifier';
$_lang['MINIFIER_INFO'] = 'Elxis può unificare file CSS e JS individuali locali e facoltativamente comprimerli. Il file unificato sarà 
	salvato nella cache. In questa maniera al posto di avere più file CSS/JS avrete un unico file minified.';
$_lang['MOBILE_VERSION'] = 'Versione mobile';
$_lang['MOBILE_VERSION_DESC'] = 'Abilitare la versione mobile per tablets?';
//Elxis 4.2
$_lang['SEND_TEST_EMAIL'] = 'Inviare mail di prova';
$_lang['ONLINE_USERS'] = 'Online per gli utenti';
$_lang['CRONJOBS'] = 'Cronologia lavori';
$_lang['CRONJOBS_INFO'] = 'Abilitare la croonologia dei lavori se si desidera eseguire operazioni automatiche come la schedulazione della pubblicazione degli articoli.';
$_lang['LANG_DETECTION'] = 'Rilevamento della lingua';
$_lang['LANG_DETECTION_INFO'] = 'Individuazione della lingua nativa e reindirizzamento alla corretta versione della lingua del sito sulla prima visita in FrontPage.';
//Elxis 4.4
$_lang['DEFENDER_NOTIFS'] = 'Notifiche Defender';
$_lang['XFRAMEOPT_HELP'] = 'Header HTTP header che controlla se il browser accetterà o non accetterà di mostrare le pagine di questo sito all´interno di un frame. Aiuta nella prevenzione di attacchi clickjacking.';
$_lang['ACCEPT_XFRAME'] = 'Permetti X-Frame';
$_lang['DENY'] = 'Negare';
$_lang['SAMEORIGIN'] = 'Stessa origine';
$_lang['ALLOW_FROM'] = 'Consenti da';
$_lang['ALLOW_FROM_ORIGIN'] = 'Permetti dall´origine';
$_lang['CONTENT_SEC_POLICY'] = 'Security Policy dei contenuti';
$_lang['IP_RANGES'] = 'IP Ranges';
$_lang['UPDATED_AUTO'] = 'Aggiornate automaticamente';
$_lang['CHECK_IP_MOMENT'] = 'Verifica momento IP';
$_lang['BEFORE_LOAD_ELXIS'] = 'Prima del caricamento del core di Elxis';
$_lang['AFTER_LOAD_ELXIS'] = 'Dopo il caricamento del core Elxis';
$_lang['CHECK_IP_MOMENT_HELP'] = 'PRIMA: Defender controlla gli IPs ogni click. IPs molesti non raggiungono il core di Elxis. 
	DOPO: Defender controlla gli IPs una volta a sessione (aumento delle performance ). IPs molesti raggiungono il core Elxis prima di essere bloccati.';
$_lang['SECURITY'] = 'Sicurezza';
$_lang['EVERYTHING'] = 'Ogni cosa';
$_lang['ONLY_ATTACKS'] = 'Solo attacchi';
$_lang['CRONJOBS_PROB'] = 'Probabilità del Cron jobs';
$_lang['CRONJOBS_PROB_INFO'] = 'La percentuale di probabilità di esecuzione del Cron jobs ad ogni click utente. Interessa solo i cron jobs eseguiti internamente da Elxis. Per le perfomance migliori più visitatori ha il tuo sito più basso il valore dovrebbe essere. Il valore di default è 10%.';
$_lang['EXTERNAL'] = 'Esterno';
$_lang['SEO_TITLES_MATCH'] = 'Controllo corrispondenza SEO';
$_lang['SEO_TITLES_MATCH_HELP'] = 'Contolla la generazione del titolo SEO. Scegliendo ESATTO genera il titolo SEO corrispondente in maniera esatta al titolo originale.';
$_lang['EXACT'] = 'Esatto';
//Elxis 4.6
$_lang['CONFIG_FOR_GMAIL'] = 'Configurazione per Gmail';
...
$_lang['PATHS_EXCLUDED_FSBK'] = 'Paths excluded from filesystem backup';
$_lang['EXCLUSIONS'] = 'Esclusioni';
//Elxis 5.0
$_lang['BACKUP_FOLDER_TABLE_TIP'] = 'Per il backup del file system è possibile selezionare il backup dell\'intera installazione di Elxis o di una cartella specifica.
Per il database è possibile eseguire il backup dell\'intero database o di una tabella specifica. Nel caso in cui si verifichi un timeout o errori di memoria durante il backup (in particolare
su siti di grandi dimensioni) selezionare per il backup di singole cartelle o tabelle.';
$_lang['FOLDER'] = 'Cartella';
$_lang['TABLE'] = 'Tabella';
$_lang['INACTIVE'] = 'Inactive';
$_lang['DEPRECATED'] = 'Deprecato';
$_lang['ALL_AVAILABLE'] = 'Tutto disponibile';
$_lang['NO_PROTECTION'] = 'Nessuna protezione';
$_lang['NEWER_VERSION_FOR'] = 'C\' è una versione più recente (%s) per %s';
$_lang['NEWER_VERSIONS_FOR'] = 'Ci sono versioni più recenti per %s';
$_lang['NEWER_VERSIONS_FOR_EXTS'] = 'Ci sono versioni più recenti per %s estensioni';
$_lang['OUTDATED_ELXIS_UPDATE_TO'] = 'Usi una versione obsoleta di Elxis! Aggiorna il prima possibile alla %s';
$_lang['NO_BACKUPS'] = 'Non hai alcun backup!';
$_lang['LONGTIME_TAKE_BACKUP'] = 'Hai molto tempo per fare un backup del sito';
$_lang['DELETE_OLD_LOGS'] = 'Elimina vecchi file di registro';
$_lang['DEFENDER_IS_DISABLED'] = 'Elxis Defender è disabilitato';
$_lang['REPO_DEF_PATH'] = 'Il repository si trova sul percorso predefinito';
$_lang['CHANGE_MAIL_TO_SMTP'] = 'Cambia PHP Mail in SMTP o altro';
$_lang['DISABLE_MULTILINGUISM'] = 'Disabilita multiligua';
$_lang['ENABLE_MULTILINGUISM'] = 'Abilita multilingua';
//Elxis 5.2
$_lang['NOTFOUND'] = 'Non trovato';
...
$_lang['EDIT_CODE'] = 'Modifica il codice';
$_lang['EXCLUDED_IPS'] = 'IP esclusi';
