...
$_lang['DELETE_SEL_ITEMS'] = 'Eliminare le voci selezionate?';
...
$_lang['CHECK_UPDATES'] = 'Controllare gli aggiornamenti';
$_lang['TODAY'] = 'Oggi';
$_lang['YESTERDAY'] = 'Ieri';
//Elxis 4.3
$_lang['PUBLISH_ON'] = 'Pubblicare il';
$_lang['UNPUBLISHED'] = 'Inedito';
$_lang['UNPUBLISH_ON'] = 'Annulla pubblicazione il';
...
$_lang['RUN_NOW'] = 'Esegui ora';
$_lang['LAST_RUN'] = 'Ultima esecuzione';
$_lang['SEC_AGO'] = '%s secondi fa';
$_lang['MIN_SEC_AGO'] = '%s min e %s secondi fa';
$_lang['HOUR_MIN_AGO'] = '1 ora e %s min fa';
$_lang['HOURS_MIN_AGO'] = '%s ore e %s min fa';
$_lang['CLICK_TOGGLE_STATUS'] = 'Clicca per attivare lo stato';
//Elxis 4.5
$_lang['IAMNOTA_ROBOT'] = 'Non sono un robot';
$_lang['VERIFY_NOROBOT'] = 'Si prega di confermare di non essere un robot!';
$_lang['CHECK_FS'] = 'Controllo Files di sistema';
//Elxis 5.0
$_lang['TOTAL_ITEMS'] = '%s articoli';
$_lang['SEARCH_OPTIONS'] = 'Opzioni di ricerca';
$_lang['FILTERS_HAVE_APPLIED'] = 'I filtri sono stati applicati';
$_lang['FILTER_BY_ITEM'] = 'Filtra per questo elemento';
$_lang['REMOVE_FILTER'] = 'Rimuovi filtro';
$_lang['TOTAL'] = 'Totale';
$_lang['OPTIONS'] = 'Opzioni';
$_lang['DISABLE'] = 'Disabilita';
$_lang['REMOVE'] = 'Rimuovi';
$_lang['ADD_ALL'] = 'Aggiungi tutto';
$_lang['TOMORROW'] = 'Domani';
$_lang['NOW'] = 'Adesso';
$_lang['MIN_AGO'] = 'Un minuto fa';
$_lang['MINS_AGO'] = '%s minuti fa';
$_lang['HOUR_AGO'] = 'Un\'ora fa';
$_lang['HOURS_AGO'] = '%s ore fa';
$_lang['IN_SEC'] = 'In %s sec';
$_lang['IN_MINUTE'] = 'In un minuto';
$_lang['IN_MINUTES'] = 'In %s minuto';
$_lang['IN_HOUR'] = 'In un\'ora';
$_lang['IN_HOURS'] = 'In %s ore';
$_lang['OTHER'] = 'Altro';
$_lang['DELETE_CURRENT_IMAGE'] = 'Elimina l\' immagine corrente';
$_lang['NO_IMAGE_FILE'] = 'Nessun file immagine!';
$_lang['SELECT_FILE'] = 'Seleziona il file';
