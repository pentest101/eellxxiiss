...
$_lang['LICENSE_NOTES'] = 'Elxis CMS is a <strong>free, open source</strong> software released under the <strong>Elxis Public License</strong> (EPL). 
...
$_lang['CNOT_REN_HTACC'] = 'Could not create rewrite file (.htaccess/web.config) in Elxis root folder.';
...
$_lang['REN_HTACCESS_MANUAL'] = 'Please create manually <strong>.htaccess</strong> (Apache) or <strong>web.config</strong> (IIS) file.';
...
//Elxis 5.0
$_lang['OTHER_LANGS'] = 'Other languages';
$_lang['OTHER_LANGS_DESC'] = 'Which other languages, except the default, you want to be available?';
$_lang['ALL_LANGS'] = 'All';
$_lang['NONE_LANGS'] = 'None';
$_lang['REMOVE'] = 'Remove';
$_lang['CONFIG_EMAIL_DISPATCH'] = 'Configure email dispatch (optional)';
$_lang['SEND_METHOD'] = 'Send method';
$_lang['RECOMMENDED'] = 'recommended';
$_lang['SECURE_CONNECTION'] = 'Secure connection';
$_lang['AUTH_REQUIRED'] = 'Authentication required';
$_lang['AUTH_METHOD'] = 'Authentication method';
$_lang['DEFAULT_METHOD'] = 'Default';
