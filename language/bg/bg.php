...
$_lang['CHECK_UPDATES'] = 'Проверете актуализации';
$_lang['TODAY'] = 'Днес';
$_lang['YESTERDAY'] = 'вчера';
//Elxis 4.3
$_lang['PUBLISH_ON'] = 'Публикуване на';
$_lang['UNPUBLISHED'] = 'непубликуван';
$_lang['UNPUBLISH_ON'] = 'Непубликуване на';
...
$_lang['ARCHIVE'] = 'Архив';
$_lang['RUN_NOW'] = 'Изпълнение сега';
$_lang['LAST_RUN'] = 'Последна екзекуция';
$_lang['SEC_AGO'] = 'Преди %s сек.';
$_lang['MIN_SEC_AGO'] = '%s min and %s sec ago';
$_lang['HOUR_MIN_AGO'] = '1 hour and %s min ago';
$_lang['HOURS_MIN_AGO'] = '%s hours and %s min ago';
$_lang['CLICK_TOGGLE_STATUS'] = 'Click to toggle status';
//Elxis 4.5
$_lang['IAMNOTA_ROBOT'] = 'Аз не съм робот';
$_lang['VERIFY_NOROBOT'] = 'Моля, потвърдете, че не сте робот!';
$_lang['CHECK_FS'] = 'Проверка на файлове';
//Elxis 5.0
$_lang['TOTAL_ITEMS'] = '%s елемента';
$_lang['SEARCH_OPTIONS'] = 'Опции за търсене';
$_lang['FILTERS_HAVE_APPLIED'] = 'Приложени са филтри';
$_lang['FILTER_BY_ITEM'] = 'Филтриране по този елемент';
$_lang['REMOVE_FILTER'] = 'Премахване на филтъра';
$_lang['TOTAL'] = 'Обща сума';
$_lang['OPTIONS'] = 'Настроики';
$_lang['DISABLE'] = 'правя неспособен';
$_lang['REMOVE'] = 'Премахване';
$_lang['ADD_ALL'] = 'Добави Всички';
$_lang['TOMORROW'] = 'Утре';
$_lang['NOW'] = 'Сега';
$_lang['MIN_AGO'] = 'Преди 1 минута';
$_lang['MINS_AGO'] = 'Преди %s минути';
$_lang['HOUR_AGO'] = 'преди 1 час';
$_lang['HOURS_AGO'] = 'преди %s часа';
$_lang['IN_SEC'] = 'За %s сек';
$_lang['IN_MINUTE'] = 'След 1 минута';
$_lang['IN_MINUTES'] = 'След %s минути';
$_lang['IN_HOUR'] = 'След 1 час';
$_lang['IN_HOURS'] = 'След %s часа';
$_lang['OTHER'] = 'Други';
$_lang['DELETE_CURRENT_IMAGE'] = 'Изтриване на текущото изображение';
$_lang['NO_IMAGE_FILE'] = 'Няма файл с изображение!';
$_lang['SELECT_FILE'] = 'Избери файл';
