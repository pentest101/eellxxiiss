...
$_lang['EMAIL'] = 'E-mail';
$_lang['INVALIDEMAIL'] = 'Άκυρη διεύθυνση ηλεκτρονικού ταχυδρομείου';
...
$_lang['CHECK_UPDATES'] = 'Έλεγχος ενημερώσεων';
$_lang['TODAY'] = 'Σήμερα';
$_lang['YESTERDAY'] = 'Χθες';
//Elxis 4.3
$_lang['PUBLISH_ON'] = 'Δημοσίευση στις';
$_lang['UNPUBLISHED'] = 'Αποδημοσιευμένο';
$_lang['UNPUBLISH_ON'] = 'Αποδημοσίευση στις';
$_lang['SCHEDULED_CRON_DIS'] = 'Υπάρχουν %s προγραμματισμένα αντικείμενα αλλά οι Χρονικές Εργασίες είναι απενεργοποιημένες!';
$_lang['CRON_DISABLED'] = 'Οι Χρονικές Εργασίες είναι απενεργοποιημένες!';
$_lang['ARCHIVE'] = 'Αρχείο';
$_lang['RUN_NOW'] = 'Εκτέλεση τώρα';
$_lang['LAST_RUN'] = 'Τελευταία εκτέλεση';
$_lang['SEC_AGO'] = 'πριν %s δευτ';
$_lang['MIN_SEC_AGO'] = 'πριν %s λεπτά και %s δευτ.';
$_lang['HOUR_MIN_AGO'] = 'πριν 1 ώρα και %s λεπτά.';
$_lang['HOURS_MIN_AGO'] = 'πριν %s ώρες και %s λεπτά.';
$_lang['CLICK_TOGGLE_STATUS'] = 'Πατήστε για αλλαγή κατάστασης';
//Elxis 4.5
$_lang['IAMNOTA_ROBOT'] = 'Δεν είμαι ρομπότ';
$_lang['VERIFY_NOROBOT'] = 'Παρακαλούμε επιβεβαιώστε ότι δεν είστε ρομπότ!';
$_lang['CHECK_FS'] = 'Έλεγχος αρχείων';
//Elxis 5.0
$_lang['TOTAL_ITEMS'] = '%s αντικείμενα';
$_lang['SEARCH_OPTIONS'] = 'Επιλογές αναζήτησης';
$_lang['FILTERS_HAVE_APPLIED'] = 'Έχουν εφαρμοστεί φίλτρα';
$_lang['FILTER_BY_ITEM'] = 'Φιλτράρισμα με αυτό το αντικείμενο';
$_lang['REMOVE_FILTER'] = 'Αφαίρεση φίλτρου';
$_lang['TOTAL'] = 'Σύνολο';
$_lang['OPTIONS'] = 'Επιλογές';
$_lang['DISABLE'] = 'Απενεργοποίηση';
$_lang['REMOVE'] = 'Αφαίρεση';
$_lang['ADD_ALL'] = 'Προσθήκη όλων';
$_lang['TOMORROW'] = 'Αύριο';
$_lang['NOW'] = 'Τώρα';
$_lang['MIN_AGO'] = 'Πριν 1 λεπτό';
$_lang['MINS_AGO'] = 'Πριν %s λεπτά';
$_lang['HOUR_AGO'] = 'Πριν 1 ώρα';
$_lang['HOURS_AGO'] = 'Πριν %s ώρες';
$_lang['IN_SEC'] = 'Σε %s δευτ';
$_lang['IN_MINUTE'] = 'Σε 1 λεπτό';
$_lang['IN_MINUTES'] = 'Σε %s λεπτά';
$_lang['IN_HOUR'] = 'Σε 1 ώρα';
$_lang['IN_HOURS'] = 'Σε %s ώρες';
$_lang['OTHER'] = 'Άλλο';
$_lang['DELETE_CURRENT_IMAGE'] = 'Διαγραφή τρέχουσας εικόνας';
$_lang['NO_IMAGE_FILE'] = 'Όχι αρχείο εικόνας!';
$_lang['SELECT_FILE'] = 'Επιλέξτε αρχείο';
