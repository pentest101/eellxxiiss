<?php 
/**
* @version		$Id: factory.class.php 1529 2014-05-31 19:01:56Z sannosi $
* @package		Elxis
* @copyright	Copyright (c) 2006-2014 elxis.org (http://www.elxis.org). All rights reserved.
...
class eFactory {
	...
	/******************************/
	static public function getPathway($pathway_here=false, $separator='nothing') {
		if (!eRegistry::isLoaded('ePathway')) {
			...
			if ($separator != 'nothing') {
				$ePathway->setSeparator($separator);
			}
